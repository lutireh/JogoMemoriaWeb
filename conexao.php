...
try {
    ...
    if($result==1){
        ...
        $sql_create_table_partida = "CREATE TABLE partida( pessoa_id int, partida_id int AUTO_INCREMENT, modo_jogo varchar(15), tam_tabuleiro varchar(3), tempo_partida time NULL, pontuacao int NULL, status varchar(10) NULL, PRIMARY KEY (partida_id) )";
